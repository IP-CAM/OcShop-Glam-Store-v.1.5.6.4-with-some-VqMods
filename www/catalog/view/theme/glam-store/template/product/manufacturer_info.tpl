...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-list">
    ...
    <div>
	  ...
	  <img class="imagejail" src="catalog/view/theme/glam-store/image/grey.gif" width="<?php echo $product['thumbwidth']; ?>" height="<?php echo $product['thumbheight']; ?>" data-src="<?php echo $product['thumb']; ?>" title="<?php echo $product['name']; ?>" alt="<?php echo $product['name']; ?>" />
	  <noscript>
