...
<?php } ?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/glam-store/stylesheet/stylesheet.css" />
...
<?php } ?>
<!--[if IE 7]> 
<link rel="stylesheet" type="text/css" href="catalog/view/theme/glam-store/stylesheet/ie7.css" />
<![endif]-->
<!--[if lt IE 7]>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/glam-store/stylesheet/ie6.css" />
...
<div id="header">
  ...
  <div class="links"><a href="<?php echo $wishlist; ?>" id="wishlist-total"><i class="fa fa-heart"></i><?php echo $text_wishlist; ?></a></div>
</div>
<?php if ($categories) { ?>
<div id="menu">
  <ul>
...
<?php if ($error) { ?>
    ...
    <div class="warning"><?php echo $error ?><img src="catalog/view/theme/glam-store/image/close.png" alt="" class="close" /></div>
