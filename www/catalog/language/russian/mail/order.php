<?php
// Text
$_['text_new_subject']          = '%s - Новый заказ %s';
$_['text_new_greeting']         = 'Спасибо за ваш заказ в магазине %s! <br />В ближайшее время мы свяжемся с вами для подтверждения заказа.';
...
$_['text_new_powered']          = 'Интернет-магазин <a href="http://glam-store.com.ua/">glam-store.com.ua</a>';
