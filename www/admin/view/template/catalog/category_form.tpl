...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab_related_wb"><?php echo $tab_related_wb; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
			  ...
			  <tr>
                ...
                <td><textarea name="category_description[<?php echo $language['language_id']; ?>][description_bottom]" id="description_bottom<?php echo $language['language_id']; ?>"><?php echo isset($category_description[$language['language_id']]) ? $category_description[$language['language_id']]['description_bottom'] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
		...
		<div id="tab_related_wb">
		<table>
		<tr>
              <td><?php echo $entry_related_wb; ?></td>
