...
$_['entry_fb']                   = 'Фейсбук:';
$_['entry_ok']                   = 'Однокласники:';
$_['entry_my']                   = 'Мой Мир:';
$_['entry_livejournal']          = 'ЖЖ:';
...
$_['entry_menu_special']         = 'Акции:<br /><span class="help">Показывать ссылку на страницу Акций в главном горизонтальном меню.</span>';
$_['entry_menu_latest']          = 'Новинки:<br /><span class="help">Показывать ссылку на страницу Новинок в главном горизонтальном меню.</span>';
$_['entry_menu_brands']          = 'Производители:<br /><span class="help">Показывать список Производителей в главном горизонтальном меню.</span>';
$_['entry_product_count']        = 'Счётчик количества товаров в категории:<br /><span class="help">Показывать количество товаров внутри подкатегорий в верхнем меню магазина. <b>Включение этой опции может привести к большим задеркам для магазинов с большим количеством подкатегорий!</b></span>';
